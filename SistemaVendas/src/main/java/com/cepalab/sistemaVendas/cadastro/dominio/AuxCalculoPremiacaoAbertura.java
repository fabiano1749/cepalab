...
public class AuxCalculoPremiacaoAbertura implements Serializable {
	...
	// Retorna true se o calculo da premiacao de abertura desse produto for por produto
	...
	//Recebe a lista de aberturas e separa as aberturas em que a premiacao abertura é por produto
	...
	//Recebe uma lista de aberturas em que a premiacao de abertura é calculada por produto
...
//MÉTODOS PARA CALCULAR AS PREMIACOES DE ABERTURAS POR TIPO DE PRODUTO	
	...
	//Recebe uma lista de abertura de produtos em que a premiação de abertura é paga por tipo de 
	...
	//Cria lista tipoProdutoQuantidade PREENCHIDA
		...
		//Recebe uma lista de aberturas em que a premiacao de abertura é calculada por Tipo de Produto
		//e retorna a soma das premiações de aberturas dessa lista
		...
		//Recebe um Tipo de Produto Quantidade e retorna a premiacao de abertura do Tipo de Produto correspondente

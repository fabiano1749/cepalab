...
public class AuxCalculoComissaoAbertura implements Serializable {
	...
	public AuxCalculoComissaoAbertura(TipoVendedor tipoVendedor, List<AberturaProduto> aberturas, List<TipoProduto> tiposProdutos) {
	...
	// Recebe uma lista de aberturas em que a comissao de abertura é paga por
	// produto
	...
	// Recebe uma lista de abertura de produtos em que a comissão de abertura é paga
	// por tipo de
	...
	// Recebe uma lista de aberturas em que a comissao de abertura é paga por Tipo
	// de Produto
	// e retorna a soma das comissões de aberturas dessa lista
	...
	// Recebe um Tipo de Produto Quantidade e retorna a comissão de abertura do Tipo

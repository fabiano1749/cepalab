...
@ViewScoped
@Named
public class FechamentoGeralBean implements Serializable {
	...
	@Inject
	private FechamentoAcertoProdutoBean acertoProdutoBean;
	...
	public void totalReceitaComissao() {
		...
		if (listaOperacoes != null) {
			for (Operacao o : listaOperacoes) {
				totalReceita = totalReceita.add(o.getReceitaTotal());
				comissoesVendas = comissoesVendas.add(o.getComissaoTotal());
			}
